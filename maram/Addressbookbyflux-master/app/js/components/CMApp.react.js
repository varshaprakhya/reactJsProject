 ...
 * the ADDSTORE and passes the new data to its children.
 */
...
var ADDSTORE = require('../stores/ADDSTORE');
var CMActions = require('../actions/CMActions');

/**
 * Retrieve the current Contacts data from the ADDSTORE
 */
function getContactsState() {
  return {
    allContacts: ADDSTORE.getAll(),
    editContact: ADDSTORE.getEditContact()
  };
}
...
var CMApp = React.createClass({
  ...
  /**
  * Event handler for 'change' events coming from the ADDSTORE
  */
  _onChange: function() {
